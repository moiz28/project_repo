...
\begin{table}[tbh]
	...
	\resizebox{\columnwidth}{!}{%
		\begin{tabular}{|c||c|c|c|c|c|}
			...
			&  & \multicolumn{4}{c|}{\textbf{abs(Cor})} \\ \cline{3-6} 
...
\begin{table}[tbh]
	\centering
	\caption{CloudStore: Summary of results after scaling}
	\label{my-label}
	\resizebox{\columnwidth}{!}{%
		\begin{tabular}{|c||c|c|c|c|c|c|c|}
			\hline
