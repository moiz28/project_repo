...
In the second step, we build a build a regression models~\cite{freedman2009statistical} using the performance metrics that are left after the reduction in the first step as independent variables and use the system throughput as dependent variable. Similar models have been build in prior research~\cite{cohen,xiong2013vperfguard}.
