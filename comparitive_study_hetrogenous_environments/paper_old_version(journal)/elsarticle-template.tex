...
\begin{document}
	...
	\begin{frontmatter}
		...
		\author{Muhammad Moiz Arif, Weiyi Shang, Emad Shihab \\ \{mo\_ari, shang, eshihab\}@encs.concorida.ca}%\fnref{myfootnote}
		\address{Department of Computer Science and Software Engineering \\ Concordia University \\ Montreal, Quebec}
		%\ead{mo_ari@encs.concordia.ca}
		%\fntext[myfootnote]{Since 1880.}
