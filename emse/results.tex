...
\noindent\fbox{%
	\parbox{\textwidth}{%
		Performance metrics typically do not follow the same distribution or follow the same trend in virtual and physical environments. Practitioners cannot compare individual performance metric with a simple scaling factor to the metrics.  
	}%
}
