...
\response{We do not compare the two environments based on load tests. We do it on the basis of typical analysis of a performance test. \cite{jack_tse}}
...
\\\\
\response{The overhead in a virtual environment is not}\\\textcolor{red}{better read the vm overhead paper and cite} them
