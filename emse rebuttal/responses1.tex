...
Say explcitly where in the paper they have mentioned or cite papers where you can see this.
Their analysis is not domain specified so we are just testing in both the envion. And we find out that its dispcrepance.
